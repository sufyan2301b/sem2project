...
<html lang="en">
	<head>
		...
		<!-- vector map CSS -->
		<link href="../Admin-assets/vendors/bower_components/jasny-bootstrap/Admin-assets/dist/css/jasny-bootstrap.min.css" rel="stylesheet" type="text/css"/>
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="form-validation.html">form Validation</a>
							</li>
							<li>
		...
		<script src="../Admin-assets/vendors/bower_components/bootstrap-validator/Admin-assets/dist/validator.min.js"></script>
