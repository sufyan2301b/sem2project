...
<html lang="en">
	<head>
		...
		<!-- Owl CSS -->
		<link href="../Admin-assets/vendors/bower_components/owl.carousel/Admin-assets/dist/assets/owl.carousel.min.css" rel="stylesheet" type="text/css">
		<link href="../Admin-assets/vendors/bower_components/owl.carousel/Admin-assets/dist/assets/owl.theme.default.min.css" rel="stylesheet" type="text/css">
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="carousel.html">Carousel</a>
							</li>
							<li>
										...
										<div id="carousel-example-captions" data-ride="carousel" class="carousel slide mt-40">
											...
											<div role="listbox" class="carousel-inner">
											   <div class="item active">
												  <img src="../Admin-assets/img/big/img1.jpg" alt="First slide image">
												  <div class="carousel-caption">
													<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
												  </div>
											   </div>
											   <div class="item">
												  <img src="../Admin-assets/img/big/img2.jpg" alt="Second slide image">
												  <div class="carousel-caption">
													 <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
												  </div>
											   </div>
											   <div class="item">
												  <img src="../Admin-assets/img/big/img3.jpg" alt="Third slide image">
												  <div class="carousel-caption">
													<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
												  </div>
											   </div>
								...
								<div class="panel panel-default card-view">
									...
									<div class="panel-wrapper collapse in">
										...
										<div id="carousel-example-captions-1" data-ride="carousel" class="carousel slide">
											...
											<div role="listbox" class="carousel-inner">
											   <div class="item active"> <img src="../Admin-assets/img/big/img4.jpg" alt="First slide image"> </div>
											   <div class="item"> <img src="../Admin-assets/img/big/img5.jpg" alt="Second slide image"> </div>
											   <div class="item"> <img src="../Admin-assets/img/big/img6.jpg" alt="Third slide image"> </div>
											</div>
										</div>
										<!-- END carousel-->
									</div>
									...
									<div  class="panel-body">
										<div class="">
											<div id="owl_demo_1" class="owl-carousel owl-theme">
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide2.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide3.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide4.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide6.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide1.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/heading-bg/slide3.jpg" alt="Owl Image"></div>
											</div>
										 </div>
									</div>
									...
									<div  class="panel-body">
										<div class="">
											<div id="owl_demo_2" class="owl-carousel owl-theme">
											   <div class="item"><img src="../Admin-assets/img/big/img1.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/big/img2.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/big/img3.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/big/img4.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/big/img5.jpg" alt="Owl Image"></div>
											   <div class="item"><img src="../Admin-assets/img/big/img6.jpg" alt="Owl Image"></div>
											</div>
										 </div>
									</div>
								</div>
		...
		<!-- Owl Init JavaScript -->
		<script src="Admin-assets/dist/js/owl-data.js"></script>
