				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="icon_dr" class="collapse collapse-level-1">
							...
							<li>
								<a class="active-page" href="simple-line-icons.html">Simple Line</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">simple-line-icons font</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>simple-line-icons</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">simple-line-icons <span class="txt-grey capitalize-font">(186 Glyphs)</span></h6>
									</div>
								...
								<div id="collapse_1" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<div class="row">
											...
											<div class="icon-container col-sm-6 col-md-4 col-lg-3">
												<div class="preview"> <i class="icon-envelope-letter"></i> icon-envolope-letter </div>
											</div>
											<div class="icon-container col-sm-6 col-md-4 col-lg-3">
