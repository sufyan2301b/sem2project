				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="pages_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="gallery.html">Gallery</a>
							</li>
							<li>
										...
										<div class="gallery-wrap">
											...
											<div class="portfolio-wrap project-gallery">
												<ul id="portfolio" class="portf auto-construct  project-gallery" data-col="3">
													<li  class="item tall branding"   data-src="../Admin-assets/img/gallery/mock1.jpg" data-sub-html="<h6>Bagwati</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>" >
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock1.jpg"  alt="Image description" />
														<span class="hover-cap">Bagwati</span>
														</a>
													</li>
													<li class="item small photography" data-src="http://www.youtube.com/watch?v=Pq9yPrLWMyU" data-poster="../Admin-assets/img/gallery/mock2.jpg"  data-sub-html="<h6>Not a Keyboard</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock2.jpg"  alt="Image description" />
														<span class="hover-cap">Not a Keyboard</span>
														</a>
													</li>
													<li class="item tall design" data-src="../Admin-assets/img/gallery/mock4.jpg" data-sub-html="<h6>Into the Woods</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock4.jpg"  alt="Image description" />
														<span class="hover-cap">Into the Woods</span>
														</a>
													</li>
													<li class="item small web" data-src="http://vimeo.com/1084537" data-poster="../Admin-assets/img/gallery/mock3.jpg" data-sub-html="<h6>Ultra Saffire</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock3.jpg"  alt="Image description" />
														<span class="hover-cap"> Ultra Saffire</span>
														</a>
													</li>
													
													<li class="item design" data-src="../Admin-assets/img/gallery/mock5.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock5.jpg"  alt="Image description" />	
														<span class="hover-cap">Happy Puppy</span>
														</a>
													</li>
													<li class="item branding" data-html="#video1" data-poster="../Admin-assets/img/gallery/mock6.jpg" data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock6.jpg"  alt="Image description" />
												...
												<div style="display:none;" id="video1">
													<video class="lg-video-object lg-html5 video-js vjs-default-skin" controls preload="none">
														<source src="../Admin-assets/videos/video1.mp4" type="video/webm">
														<source src="../Admin-assets/videos/video1.webm" type="video/webm">
										...
										<div class="gallery-wrap">
											<div class="portfolio-wrap project-gallery">
												<ul id="portfolio_1" class="portf auto-construct  project-gallery" data-col="4">
													<li  class="item tall"   data-src="../Admin-assets/img/gallery/mock1.jpg" data-sub-html="<h6>Bagwati</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>" >
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock1.jpg"  alt="Image description" />
														<span class="hover-cap">Bagwati</span>
														</a>
													</li>
													<li class="item small" data-src="http://www.youtube.com/watch?v=Pq9yPrLWMyU" data-poster="../Admin-assets/img/gallery/mock2.jpg"  data-sub-html="<h6>Not a Keyboard</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock2.jpg"  alt="Image description" />
														<span class="hover-cap">Not a Keyboard</span>
														</a>
													</li>
													<li class="item tall" data-src="../Admin-assets/img/gallery/mock4.jpg" data-sub-html="<h6>Into the Woods</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock4.jpg"  alt="Image description" />
														<span class="hover-cap">Into the Woods</span>
														</a>
													</li>
													<li class="item small" data-src="http://vimeo.com/1084537" data-poster="../Admin-assets/img/gallery/mock3.jpg" data-sub-html="<h6>Ultra Saffire</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock3.jpg"  alt="Image description" />
														<span class="hover-cap"> Ultra Saffire</span>
														</a>
													...
													<li class="item" data-src="../Admin-assets/img/gallery/mock5.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock5.jpg"  alt="Image description" />	
														<span class="hover-cap">Happy Puppy</span>
														</a>
													</li>
													<li class="item" data-html="#video2" data-poster="../Admin-assets/img/gallery/mock6.jpg" data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
														<a href="">
														<img class="img-responsive" src="../Admin-assets/img/gallery/mock6.jpg"  alt="Image description" />
														<span class="hover-cap">Wooden Closet</span>
														</a>
