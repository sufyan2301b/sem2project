				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="pricing.html">Pricing Tables</a>
							</li>
							<li>
										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-6 col-sm-12 text-center mb-30">
												<div class="panel panel-pricing mb-0">
													...
													<div class="panel-footer pb-35">
														<a class="btn btn-warning btn-rounded btn-lg" href="#">download now</a>
													</div>
												</div>
											</div>
											<!-- /item -->
											...
											<div class="col-lg-3 col-md-6 col-sm-12 text-center mb-30">
												<div class="panel panel-pricing mb-0">
													...
													<div class="panel-footer pb-35">
														<a class="btn btn-warning btn-rounded btn-lg" href="#">subscribe now</a>
													</div>
												</div>
											</div>
											<!-- /item -->
