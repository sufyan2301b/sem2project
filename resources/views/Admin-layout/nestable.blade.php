...
<html lang="en">
	<head>
		...
		<!--Nestable CSS -->
		<link href="../Admin-assets/vendors/bower_components/nestable2/jquery.nestable.css" rel="stylesheet" type="text/css" />
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="nestable.html">Nestables</a>
							</li>
							<li>
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>nestable</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Nestable type 1</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
						...
						<div class="col-md-4">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Nestable type 2</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
						...
						<div class="col-md-4">
						  <div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Nestable type 3</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="dd myadmin-dd" id="nestable_menu">
											<ol class="dd-list">
		...
		<script src="Admin-assets/dist/js/nestable-data.js"></script>
