...
<html lang="en">
	<head>
		...
		<!-- Footable CSS -->
		<link href="../Admin-assets/vendors/bower_components/jsgrid/Admin-assets/dist/jsgrid.min.css" rel="stylesheet" type="text/css"/>
		<link href="../Admin-assets/vendors/bower_components/jsgrid/Admin-assets/dist/jsgrid-theme.min.css" rel="stylesheet" type="text/css"/>
		<!-- Custom CSS -->
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="jsgrid-table.html">Jsgrid Table</a>
							</li>
						</ul>
					</li>
					<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">jsgrid table</h5>
						</div>
						<!-- Breadcrumb -->
		...
		<script src="Admin-assets/dist/js/db.js"></script>
		<script src="../vendors/bower_components/jsgrid/Admin-assets/dist/jsgrid.min.js"></script>
		<script src="Admin-assets/dist/js/jsgrid-data.js"></script>
