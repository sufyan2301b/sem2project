...
<html lang="en">
	...
	<body>
									...
									<div class="col-sm-12 col-xs-12">
										...
										<div class="form-wrap">
											<form action="#">
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-warning btn-rounded">Enter</button>
												</div>
												<div class="form-group mb-0 text-center">
													<a href="#" class="inline-block txt-orange">Switch User</a>
												</div>
											</form>
										</div>
									</div>	
		...
		<script src="../vendors/bower_components/jasny-bootstrap/Admin-assets/dist/js/jasny-bootstrap.min.js"></script>
