...
<head>
	...
	<link href="../Admin-assets/vendors/bower_components/jquery-toast-plugin/Admin-assets/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">
...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="chart_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="echart.html">Echart Chart</a>
						</li>
						<li>
	...
	<script src="../Admin-assets/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
	<script src="Admin-assets/dist/js/simpleweather-data.js"></script>
	...
	<script src="../Admin-assets/vendors/jquery.sparkline/Admin-assets/dist/jquery.sparkline.min.js"></script>
	
	<!-- Owl JavaScript -->
	<script src="../Admin-assets/vendors/bower_components/owl.carousel/Admin-assets/dist/owl.carousel.min.js"></script>
	
	<!-- Toast JavaScript -->
	<script src="../Admin-assets/vendors/bower_components/jquery-toast-plugin/Admin-assets/dist/jquery.toast.min.js"></script>
	
	<!-- EChartJS JavaScript -->
	<script src="../Admin-assets/vendors/bower_components/echarts/Admin-assets/dist/echarts-en.min.js"></script>
	...
	<script src="Admin-assets/dist/js/echart-data.js"></script>
</body>
