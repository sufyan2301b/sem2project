...
<head>
	...
	<!-- Bootstrap table CSS -->
	<link href="../Admin-assets/vendors/bower_components/bootstrap-table/Admin-assets/dist/bootstrap-table.css" rel="stylesheet" type="text/css"/>
...
<body>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<table data-toggle="table" data-buttons-class='default btn-sm btn-outline' data-pagination="true" data-search="true"   data-url="Admin-assets/dist/json/bootstrap-table.json" data-height="280" data-mobile-responsive="true" data-sort-order="desc" class="table">
											<thead>
												<tr>
												  <th data-field="id" 
	...
	<script src="../Admin-assets/vendors/bower_components/bootstrap-table/Admin-assets/dist/bootstrap-table.min.js"></script>
	<script src="Admin-assets/dist/js/bootstrap-table-data.js"></script>
