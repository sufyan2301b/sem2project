			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="chart_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="sparkline.html">Sparkline</a>
						</li>
						<li>
			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">sparkline</h5>
					</div>
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>sparkline</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						 <div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">filled line</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">composite bar chart</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
