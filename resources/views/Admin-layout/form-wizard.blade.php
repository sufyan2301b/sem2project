...
<html lang="en">
	<head>
		...
		<title>Snoopy I Next Level Admin template</title>
		<meta name="description" content="Snoopy is a responsive HTML5 admin template by hencework." />
		...
		<!-- vector map CSS -->
		<link href="../Admin-assets/vendors/bower_components/jquery-wizard.js/css/wizard.css" rel="stylesheet" type="text/css"/>
		
		<!-- jquery-steps css -->
		<link rel="stylesheet" href="../Admin-assets/vendors/bower_components/jquery.steps/demo/css/jquery.steps.css">
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="form-wizard.html">Form Wizard</a>
							</li>
							<li>
		...
		<script src="../Admin-assets/vendors/bower_components/jasny-bootstrap/Admin-assets/dist/js/jasny-bootstrap.min.js"></script>		
		
		<!-- Form Wizard JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/jquery.steps/build/jquery.steps.min.js"></script>
		<script src="https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/jquery.validate.min.js"></script>
		
		<!-- Form Wizard Data JavaScript -->
		<script src="Admin-assets/dist/js/form-wizard-data.js"></script>
		...
		<!-- Starrr JavaScript -->
		<script src="Admin-assets/dist/js/starrr.js"></script>
