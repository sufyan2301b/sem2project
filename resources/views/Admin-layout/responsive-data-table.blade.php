...
<head>
	...
	<link href="../Admin-assets/vendors/bower_components/datatables.net-responsive/css/responsive.dataTables.min.css" rel="stylesheet" type="text/css"/>
...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="responsive-data-table.html">RSPV DataTable</a>
						</li>
						<li>
	...
	<script src="../Admin-assets/vendors/bower_components/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
	<script src="../Admin-assets/dist/js/responsive-datatable-data.js"></script>
