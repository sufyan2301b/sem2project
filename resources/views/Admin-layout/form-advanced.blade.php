...
<html lang="en">
	<head>
		...
		<link href="../Admin-assets/vendors/bower_components/mjolnic-bootstrap-colorpicker/Admin-assets/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet" type="text/css"/>
		
		<!-- select2 CSS -->
		<link href="../Admin-assets/vendors/bower_components/select2/Admin-assets/dist/css/select2.min.css" rel="stylesheet" type="text/css"/>
		
		<!-- switchery CSS -->
		<link href="../Admin-assets/vendors/bower_components/switchery/Admin-assets/dist/switchery.min.css" rel="stylesheet" type="text/css"/>
		
		<!-- bootstrap-select CSS -->
		<link href="../Admin-assets/vendors/bower_components/bootstrap-select/Admin-assets/dist/css/bootstrap-select.min.css" rel="stylesheet" type="text/css"/>
		
		<!-- bootstrap-tagsinput CSS -->
		<link href="../Admin-assets/vendors/bower_components/bootstrap-tagsinput/Admin-assets/dist/bootstrap-tagsinput.css" rel="stylesheet" type="text/css"/>
		
		<!-- bootstrap-touchspin CSS -->
		<link href="../Admin-assets/vendors/bower_components/bootstrap-touchspin/Admin-assets/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" type="text/css"/>
		
		<!-- multi-select CSS -->
		<link href="../Admin-assets/vendors/bower_components/multiselect/css/multi-select.css" rel="stylesheet" type="text/css"/>
		
		<!-- Bootstrap Switches CSS -->
		<link href="../Admin-assets/vendors/bower_components/bootstrap-switch/Admin-assets/dist/css/bootstrap3/bootstrap-switch.min.css" rel="stylesheet" type="text/css"/>
	...
	<body>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															...
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#71aa68"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#e6b034"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#da473a"/>
										...
										<div class="form-wrap">
											<form>
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#71aa68" data-secondary-color="#e6b034" />
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#e6b034"  data-secondary-color="#71aa68" />
														</div>
													</div>
												</div>
											</form>
		...
		<script src="../Admin-assets/vendors/bower_components/mjolnic-bootstrap-colorpicker/Admin-assets/dist/js/bootstrap-colorpicker.min.js"></script>
		
		<!-- Switchery JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/switchery/Admin-assets/dist/switchery.min.js"></script>
		
		<!-- Select2 JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/select2/Admin-assets/dist/js/select2.full.min.js"></script>
		
		<!-- Bootstrap Select JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/bootstrap-select/Admin-assets/dist/js/bootstrap-select.min.js"></script>
		
		<!-- Bootstrap Tagsinput JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/bootstrap-tagsinput/Admin-assets/dist/bootstrap-tagsinput.min.js"></script>
		
		<!-- Bootstrap Touchspin JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/bootstrap-touchspin/Admin-assets/dist/jquery.bootstrap-touchspin.min.js"></script>
		
		<!-- Multiselect JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/multiselect/js/jquery.multi-select.js"></script>
		
		 
		<!-- Bootstrap Switch JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/bootstrap-switch/Admin-assets/dist/js/bootstrap-switch.min.js"></script>
		...
		<script src="Admin-assets/dist/js/form-advance-data.js"></script>
