...
<html lang="en">
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="icon_dr" class="collapse collapse-level-1">
							...
							<li>
								<a class="active-page" href="linea-icon.html">Linea</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">linea-icons font</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>linea-icons</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Basic Icons <span class="txt-grey capitalize-font">(135 Glyphs)</span></h6>
									</div>
								...
								<div id="collapse_1" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-basic</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-basic"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Basic Elaborate Icons <span class="txt-grey capitalize-font">(145 Glyphs)</span></h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_2" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-elaborate</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-elaborate"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Ecommerece Icons <span class
										="txt-grey capitalize-font">(85 Glyphs)</span></h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_3" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-ecommerce</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-ecommerce"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Software Icons 
										<span class="txt-grey capitalize-font">(100 Glyphs)</span>
										</h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_4" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-software</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-software"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Weather Icons 
										<span class="txt-grey capitalize-font">(85 Glyphs)</span>
										</h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_5" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-weather</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-weather"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Music Icons  <span class="txt-grey capitalize-font">(30 Glyphs)</span></h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_6" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-music</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-music"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Aerrow Icons
										 <span class="txt-grey capitalize-font">(136 Glyphs)</span>
										</h6>
									</div>
									<div class="pull-right">
								...
								<div id="collapse_7" class="panel-wrapper collapse in">
									<div  class="panel-body">
										<p class="muted"> Use <code>linea-aerrow</code> class: <code>&lt;div data-icon="a" class="linea-icon linea-aerrow"&gt;&lt;/div&gt;</code></p>
										<ul class="glyphs character-mapping mt-40">
											<li>
		...
		<!-- jQuery -->
		<script src="../vendors/bower_components/jquery/Admin-assets/dist/jquery.min.js"></script>
		
		<!-- Bootstrap Core JavaScript -->
		<script src="../vendors/bower_components/bootstrap/Admin-assets/dist/js/bootstrap.min.js"></script>
		...
		<!-- Owl JavaScript -->
		<script src="../vendors/bower_components/owl.carousel/Admin-assets/dist/owl.carousel.min.js"></script>
		
		<!-- Switchery JavaScript -->
		<script src="../vendors/bower_components/switchery/Admin-assets/dist/switchery.min.js"></script>
