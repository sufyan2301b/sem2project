...
<html lang="en">
	<head>
		...
		<!-- xeditable css -->
		<link href="../Admin-assets/vendors/bower_components/x-editable/Admin-assets/dist/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet" />
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="form-x-editable.html">X-Editable</a>
							</li>
							<li>
		...
		<script type="text/javascript" src="../Admin-assets/vendors/bower_components/x-editable/Admin-assets/dist/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
