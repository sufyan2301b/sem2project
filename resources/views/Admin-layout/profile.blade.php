...
<head>
	...
	<!-- Morris Charts CSS -->
    <link href="../Admin-assets/vendors/bower_components/morris.js/morris.css" rel="stylesheet" type="text/css"/>
	
	<!-- vector map CSS -->
	<link href="../Admin-assets/vendors/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" type="text/css"/>
	
	<!-- Calendar CSS -->
	<link href="../Admin-assets/vendors/bower_components/fullcalendar/dist/fullcalendar.css" rel="stylesheet" type="text/css"/>
...
<body>
									...
									<div class="profile-box">
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<img class="inline-block mb-10" src="../Admin-assets/img/mock1.jpg" alt="user"/>
												<div class="fileupload btn btn-default">
													<span class="btn-text">edit</span>
													<input class="upload" type="file">
												</div>
																...
																<a href="javascript:void(0)">
																	...
																	<div class="sl-content">
																		...
																		<div class="activity-thumbnail">
																			<img src="../Admin-assets/img/thumb-1.jpg" alt="thumbnail"/>
																			<img src="../Admin-assets/img/thumb-2.jpg" alt="thumbnail"/>
																			<img src="../Admin-assets/img/thumb-3.jpg" alt="thumbnail"/>
																		</div>
																...
																<li class="follow-list">
																	<div class="follo-body">
																		<div class="follo-data">
																			...
																			<button class="btn btn-warning pull-right btn-xs fixed-btn">Follow</button>
																			<div class="clearfix"></div>
																		</div>
																		<div class="follo-data">
																			<img class="user-img img-circle"  src="../Admin-assets/img/user1.png" alt="user"/>
																			...
																			<button class="btn btn-warning btn-outline pull-right btn-xs fixed-btn">following</button>
																			<div class="clearfix"></div>
																		</div>
																		<div class="follo-data">
																			<img class="user-img img-circle"  src="../Admin-assets/img/user2.png" alt="user"/>
													...
													<div class="gallery-wrap">
														<div class="portfolio-wrap project-gallery">
															<ul id="portfolio_1" class="portf auto-construct  project-gallery" data-col="4">
																<li  class="item"   data-src="../Admin-assets/img/gallery/equal-size/mock1.jpg" data-sub-html="<h6>Bagwati</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>" >
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock1.jpg"  alt="Image description" />
																	<span class="hover-cap">Bagwati</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock2.jpg"   data-sub-html="<h6>Not a Keyboard</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock2.jpg"  alt="Image description" />
																	<span class="hover-cap">Not a Keyboard</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock3.jpg" data-sub-html="<h6>Into the Woods</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock3.jpg"  alt="Image description" />
																	<span class="hover-cap">Into the Woods</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock4.jpg"  data-sub-html="<h6>Ultra Saffire</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock4.jpg"  alt="Image description" />
																	<span class="hover-cap"> Ultra Saffire</span>
																	</a>
																</li>
																
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock5.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock5.jpg"  alt="Image description" />	
																	<span class="hover-cap">Happy Puppy</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock6.jpg"  data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock6.jpg"  alt="Image description" />
																	<span class="hover-cap">Wooden Closet</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock7.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock7.jpg"  alt="Image description" />	
																	<span class="hover-cap">Happy Puppy</span>
																	</a>
																</li>
																<li class="item" data-src="../Admin-assets/img/gallery/equal-size/mock8.jpg"  data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="../Admin-assets/img/gallery/equal-size/mock8.jpg"  alt="Image description" />
																	<span class="hover-cap">Wooden Closet</span>
																	</a>
																</li>
															</ul>
    ...
    <script src="../Admin-assets/vendors/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="../Admin-assets/vendors/vectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script src="../Admin-assets/dist/js/vectormap-data.js"></script>
	
	<!-- Calender JavaScripts -->
	<script src="../Admin-assets/vendors/bower_components/moment/min/moment.min.js"></script>
	<script src="../Admin-assets/vendors/jquery-ui.min.js"></script>
	<script src="../Admin-assets/vendors/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
	<script src="../Admin-assets/dist/js/fullcalendar-data.js"></script>
	...
	<script src="../Admin-assets/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
	<script src="dist/js/skills-counter-data.js"></script>
	
	<!-- Morris Charts JavaScript -->
    <script src="../Admin-assets/vendors/bower_components/raphael/raphael.min.js"></script>
    <script src="../Admin-assets/vendors/bower_components/morris.js/morris.min.js"></script>
    <script src="../Admin-assets/dist/js/morris-data.js"></script>
	...
	<!-- Gallery JavaScript -->
	<script src="../Admin-assets/dist/js/isotope.js"></script>
	<script src="../Admin-assets/dist/js/lightgallery-all.js"></script>
	<script src="../Admin-assets/dist/js/froogaloop2.min.js"></script>
	<script src="../Admin-assets/dist/js/gallery-data.js"></script>
	../Admin-assets/
	<!-- twitter ../Admin-assets/JavaScript -->
	<script src="../Admin-assets/dist/js/twitterFetcher.js"></script>
	../Admin-assets/
	<!-- Spectrag../Admin-assets/ram JavaScript -->
	<script src="../Admin-assets/dist/js/spectragram.min.js"></script>
	
	<!-- Init JavaScript -->
	<script src="../Admin-assets/dist/js/init.js"></script>
	<script src="../Admin-assets/dist/js/widgets-data.js"></script>
