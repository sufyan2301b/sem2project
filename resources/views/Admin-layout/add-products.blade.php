												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="firstName" class="form-control" name="pname" placeholder="Cosmetics & Jewellery">
														</div>
													</div>
													<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="pprice" id="exampleInputuname" placeholder="price">
															</div>
														</div>
													</div>
													<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<select class="form-control" name="product" data-placeholder="Choose a Category" tabindex="1">
																<option value="Category 1">Cosmetics</option>
																<option value="Category 2">Jewelley</option>
															</select>
														</div>
													</div>
													<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="firstName" class="form-control" name="pquantity"placeholder="Cosmetics & Jewellery">
														</div>
													</div>
												<!-- Row -->
												<!--/row-->
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="img-upload-wrap">
															<img class="img-responsive" src="../Admin-assets/img/chair.jpg" alt="upload_img">
														</div>
														<br>
