...
<head>
	...
	<!-- Tablesaw table CSS -->
	<link href="../Admin-assets/vendors/bower_components/filament-tablesaw/dist/tablesaw.css" rel="stylesheet" type="text/css"/>
...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="responsive-table.html">Responsive Table</a>
						</li>
						<li>
	...
	<script src="../Admin-assets/vendors/bower_components/filament-tablesaw/dist/tablesaw.js"></script>
	<script src="../Admin-assets/dist/js/tablesaw-data.js"></script>
