...
<html lang="en">
	<head>
		...
		<!-- Bootstrap Treeview -->
		<link href="../Admin-assets/vendors/bower_components/bootstrap-treeview/Admin-assets/dist/bootstrap-treeview.min.css" rel="stylesheet" type="text/css">
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="bootstrap-treeview.html">Tree View</a>
							</li>
							<li>
		...
		<!-- Treeview JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/bootstrap-treeview/Admin-assets/dist/bootstrap-treeview.min.js"></script>
		
		<!-- Treeview Init JavaScript -->
		<script src="Admin-assets/dist/js/treeview-data.js"></script>
