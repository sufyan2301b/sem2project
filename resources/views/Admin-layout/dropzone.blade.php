...
<html lang="en">
	<head>
		...
		<link href="../Admin-assets/vendors/bower_components/dropzone/Admin-assets/dist/dropzone.css" rel="stylesheet" type="text/css"/>
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="dropzone.html">Dropzone</a>
							</li>
							<li>
		...
		<!-- Dropzone JavaScript -->
		<script src="../Admin-assets/vendors/bower_components/dropzone/Admin-assets/dist/dropzone.js"></script>
		
		<!-- Dropzone Init JavaScript -->
		<script src="Admin-assets/dist/js/dropzone-data.js"></script>
