...
<head>
	...
	<!-- Chartist CSS -->
	<link href="../Admin-assets/vendors/bower_components/chartist/Admin-assets/dist/chartist.min.css" rel="stylesheet" type="text/css"/>
...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="chart_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="chartist.html">chartist</a>
						</li>
						<li>
	...
	<!-- Chartist JavaScript -->
	<script src="../Admin-assets/vendors/bower_components/chartist/Admin-assets/dist/chartist.min.js"></script>
	<script src="Admin-assets/dist/js/chartist-data.js"></script>
