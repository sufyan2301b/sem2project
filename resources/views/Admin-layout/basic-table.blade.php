...
<body>
										  ...
										  <table class="table table-hover mb-0">
											...
											<tbody>
											  ...
											  <tr>
												...
												<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#ed8739"], "stroke":["#ed8739"]}' data-height="40">0,-1,1,-2,-3,1,-2,-3,1,-2</span> </td>
												<td><span class="text-warning text-semibold"><i class="fa fa-level-down" aria-hidden="true"></i> 8.55%</span> </td>
											  </tr>
											  <tr>
												<td>3</td>
												<td>RC Cars</td>
												<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#ed8739"], "stroke":["#ed8739"]}' data-height="40">0,3,6,1,2,4,6,3,2,1</span> </td>
												<td><span class="text-success text-semibold"><i class="fa fa-level-up" aria-hidden="true"></i> 58.56%</span> </td>
											  </tr>
											  <tr>
												<td>4</td>
												<td>Down Coat</td>
												<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#ed8739"], "stroke":["#ed8739"]}' data-height="40">0,3,6,4,5,4,7,3,4,2</span> </td>
	...
	<!-- Piety JavaScript -->
	<script src="../Admin-assets/vendors/bower_components/peity/jquery.peity.min.js"></script>
	<script src="Admin-assets/dist/js/peity-data.js"></script>
