				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="bootstrap-ui.html">Bootstrap UI</a>
							</li>
						</ul>
					</li>
					<li>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="button-list mt-25">
											...
											<button class="btn btn-warning " type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Link with button</button>
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="row mt-40">
											<div class="col-sm-4">
												<img src="../Admin-assets/img/big/img1.jpg" alt="image" class="img-responsive img-rounded" width="250"/>
											</div>
											<div class="col-sm-4 text-center">
												<img src="../Admin-assets/img/big/circle.jpg" alt="image" class="img-circle" width="170" />
											</div>
											<div class="col-sm-4 text-right">
												<img src="../Admin-assets/img/big/img3.jpg" alt="image" class="img-thumbnail " width="250"/>
											</div>
										</div>
									</div>
								</div>
