...
<html lang="en">
	<head>
		...
		<!-- Summernote css -->
		<link rel="stylesheet" href="../Admin-assets/vendors/bower_components/summernote/dist/summernote.css" />
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="summernote-wysihtml5.html">summernote</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">summernote</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>summernote</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Summernote wysihtml5</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
		...
		<script src="../Admin-assets/vendors/bower_components/summernote/dist/summernote.min.js"></script>
