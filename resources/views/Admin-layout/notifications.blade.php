...
<html lang="en">
	...
	<body>
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Welcome to Snoopy Dashboard. 
										</div>
							...
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<i class="zmdi zmdi-info-outline pr-15 pull-left"></i><p class="pull-left">Welcome to Snoopy Dashboard.</p> 
											<div class="clearfix"></div>
										</div>
										<div class="alert alert-warning alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable alert-style-1">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<i class="zmdi zmdi-info-outline"></i>Welcome to Snoopy Dashboard. 
										</div>
		...
		<script src="../vendors/bower_components/jquery-toast-plugin/Admin-assets/dist/jquery.toast.min.js"></script>
		...
		<!-- Init JavaScript -->
		<script src="Admin-assets/dist/js/toast-data.js"></script>
