...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="editable-table.html">Editable Table</a>
						</li>
						<li>
	...
	<script src="../Admin-assets/vendors/bower_components/editable-table/mindmup-editabletable.js"></script>
	<script src="../Admin-assets/vendors/bower_components/editable-table/numeric-input-example.js"></script>
	<script src="Admin-assets/dist/js/editable-table-data.js"></script>
