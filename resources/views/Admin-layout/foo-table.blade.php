...
<html lang="en">
	<head>
		...
		<!-- Footable CSS -->
		<link href="../Admin-assets/vendors/bower_components/FooTable/compiled/footable.bootstrap.min.css" rel="stylesheet" type="text/css"/>
		<!-- Custom CSS -->
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="foo-table.html">Foo Table</a>
							</li>
							<li>
		...
		<script src="../Admin-assets/vendors/bower_components/FooTable/compiled/footable.min.js" type="text/javascript"></script>
		<script src="Admin-assets/dist/js/footable-data.js"></script>
