...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="chart_dr" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a class="active-page" href="easy-pie-chart.html">Easy Pie Chart</a>
						</li>
						<li>
									...
									<div class="row">
										<div class="col-sm-4 mb-15 text-center">
											<span id="pie_chart_7" class="easypiechart" data-percent="40">
												<span><img src="../Admin-assets/img/user.png" alt="user"  class="img-circle"/></span>
											</span>
										</div>
										<div class="col-sm-4 mb-15 text-center">
											<span id="pie_chart_8" class="easypiechart" data-percent="50">
												<span><img src="../Admin-assets/img/user1.png" alt="user"  class="img-circle"/></span>
											</span>
										</div>
										<div class="col-sm-4 mb-15 text-center">
											<span id="pie_chart_9" class="easypiechart" data-percent="90">
												<span><img src="../Admin-assets/img/user2.png" alt="user"  class="img-circle"/></span>
											</span>
										</div>
									</div>	
								</div>
	...
	<script src="../Admin-assets/vendors/bower_components/jquery.easy-pie-chart/Admin-assets/dist/jquery.easypiechart.min.js"></script>
	<script src="Admin-assets/dist/js/easypiechart-data.js"></script>
