				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="icon_dr" class="collapse collapse-level-1">
							...
							<li>
								<a class="active-page" href="pe-icon-7.html">Pe-icon-7</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Pe-icon-7 font</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>Pe-icon-7</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">PE-ICON-7 <span class="txt-grey capitalize-font">(202 Glyphs)</span></h6>
									</div>
										...
										<div class="row">
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-album"></span>
													<input type="text" value="pe-7s-album" readonly class="font-icon-name">
												</div>
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-arc"></span>
													<input type="text" value="pe-7s-arc" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-back-2"></span>
													<input type="text" value="pe-7s-back-2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bandaid"></span>
													<input type="text" value="pe-7s-bandaid" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-car"></span>
													<input type="text" value="pe-7s-car" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-diamond"></span>
													<input type="text" value="pe-7s-diamond" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-door-lock"></span>
													<input type="text" value="pe-7s-door-lock" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-eyedropper"></span>
													<input type="text" value="pe-7s-eyedropper" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-female"></span>
													<input type="text" value="pe-7s-female" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-gym"></span>
													<input type="text" value="pe-7s-gym" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-hammer"></span>
													<input type="text" value="pe-7s-hammer" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-headphones"></span>
													<input type="text" value="pe-7s-headphones" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-helm"></span>
													<input type="text" value="pe-7s-helm" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-hourglass"></span>
													<input type="text" value="pe-7s-hourglass" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-leaf"></span>
													<input type="text" value="pe-7s-leaf" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-magic-wand"></span>
													<input type="text" value="pe-7s-magic-wand" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-male"></span>
													<input type="text" value="pe-7s-male" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-map-2"></span>
													<input type="text" value="pe-7s-map-2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-next-2"></span>
													<input type="text" value="pe-7s-next-2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-paint-bucket"></span>
													<input type="text" value="pe-7s-paint-bucket" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-pendrive"></span>
													<input type="text" value="pe-7s-pendrive" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-photo"></span>
													<input type="text" value="pe-7s-photo" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-piggy"></span>
													<input type="text" value="pe-7s-piggy" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-plugin"></span>
													<input type="text" value="pe-7s-plugin" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-refresh-2"></span>
													<input type="text" value="pe-7s-refresh-2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-rocket"></span>
													<input type="text" value="pe-7s-rocket" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-settings"></span>
													<input type="text" value="pe-7s-settings" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-shield"></span>
													<input type="text" value="pe-7s-shield" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-smile"></span>
													<input type="text" value="pe-7s-smile" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-usb"></span>
													<input type="text" value="pe-7s-usb" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-vector"></span>
													<input type="text" value="pe-7s-vector" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-wine"></span>
													<input type="text" value="pe-7s-wine" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cloud-upload"></span>
													<input type="text" value="pe-7s-cloud-upload" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cash"></span>
													<input type="text" value="pe-7s-cash" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-close"></span>
													<input type="text" value="pe-7s-close" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bluetooth"></span>
													<input type="text" value="pe-7s-bluetooth" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cloud-download"></span>
													<input type="text" value="pe-7s-cloud-download" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-way"></span>
													<input type="text" value="pe-7s-way" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-close-circle"></span>
													<input type="text" value="pe-7s-close-circle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-id"></span>
													<input type="text" value="pe-7s-id" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-up"></span>
													<input type="text" value="pe-7s-angle-up" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-wristwatch"></span>
													<input type="text" value="pe-7s-wristwatch" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-up-circle"></span>
													<input type="text" value="pe-7s-angle-up-circle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-world"></span>
													<input type="text" value="pe-7s-world" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-right"></span>
													<input type="text" value="pe-7s-angle-right" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-volume"></span>
													<input type="text" value="pe-7s-volume" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-right-circle"></span>
													<input type="text" value="pe-7s-angle-right-circle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-users"></span>
													<input type="text" value="pe-7s-users" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-left"></span>
													<input type="text" value="pe-7s-angle-left" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-user-female"></span>
													<input type="text" value="pe-7s-user-female" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-left-circle"></span>
													<input type="text" value="pe-7s-angle-left-circle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-up-arrow"></span>
													<input type="text" value="pe-7s-up-arrow" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-down"></span>
													<input type="text" value="pe-7s-angle-down" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-switch"></span>
													<input type="text" value="pe-7s-switch" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-angle-down-circle"></span>
													<input type="text" value="pe-7s-angle-down-circle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-scissors"></span>
													<input type="text" value="pe-7s-scissors" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-wallet"></span>
													<input type="text" value="pe-7s-wallet" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-safe"></span>
													<input type="text" value="pe-7s-safe" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-volume2"></span>
													<input type="text" value="pe-7s-volume2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-volume1"></span>
													<input type="text" value="pe-7s-volume1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-voicemail"></span>
													<input type="text" value="pe-7s-voicemail" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-video"></span>
													<input type="text" value="pe-7s-video" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-user"></span>
													<input type="text" value="pe-7s-user" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-upload"></span>
													<input type="text" value="pe-7s-upload" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-unlock"></span>
													<input type="text" value="pe-7s-unlock" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-umbrella"></span>
													<input type="text" value="pe-7s-umbrella" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-trash"></span>
													<input type="text" value="pe-7s-trash" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-tools"></span>
													<input type="text" value="pe-7s-tools" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-timer"></span>
													<input type="text" value="pe-7s-timer" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-ticket"></span>
													<input type="text" value="pe-7s-ticket" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-target"></span>
													<input type="text" value="pe-7s-target" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-sun"></span>
													<input type="text" value="pe-7s-sun" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-study"></span>
													<input type="text" value="pe-7s-study" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-stopwatch"></span>
													<input type="text" value="pe-7s-stopwatch" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-star"></span>
													<input type="text" value="pe-7s-star" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-speaker"></span>
													<input type="text" value="pe-7s-speaker" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-signal"></span>
													<input type="text" value="pe-7s-signal" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-shuffle"></span>
													<input type="text" value="pe-7s-shuffle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-shopbag"></span>
													<input type="text" value="pe-7s-shopbag" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-share"></span>
													<input type="text" value="pe-7s-share" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-server"></span>
													<input type="text" value="pe-7s-server" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-search"></span>
													<input type="text" value="pe-7s-search" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-film"></span>
													<input type="text" value="pe-7s-film" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-science"></span>
													<input type="text" value="pe-7s-science" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-disk"></span>
													<input type="text" value="pe-7s-disk" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-ribbon"></span>
													<input type="text" value="pe-7s-ribbon" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-repeat"></span>
													<input type="text" value="pe-7s-repeat" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-refresh"></span>
													<input type="text" value="pe-7s-refresh" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-add-user"></span>
													<input type="text" value="pe-7s-add-user" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-refresh-cloud"></span>
													<input type="text" value="pe-7s-refresh-cloud" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-paperclip"></span>
													<input type="text" value="pe-7s-paperclip" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-radio"></span>
													<input type="text" value="pe-7s-radio" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-note2"></span>
													<input type="text" value="pe-7s-note2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-print"></span>
													<input type="text" value="pe-7s-print" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-network"></span>
													<input type="text" value="pe-7s-network" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-prev"></span>
													<input type="text" value="pe-7s-prev" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-mute"></span>
													<input type="text" value="pe-7s-mute" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-power"></span>
													<input type="text" value="pe-7s-power" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-medal"></span>
													<input type="text" value="pe-7s-medal" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-portfolio"></span>
													<input type="text" value="pe-7s-portfolio" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-like2"></span>
													<input type="text" value="pe-7s-like2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-plus"></span>
													<input type="text" value="pe-7s-plus" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-left-arrow"></span>
													<input type="text" value="pe-7s-left-arrow" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-play"></span>
													<input type="text" value="pe-7s-play" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-key"></span>
													<input type="text" value="pe-7s-key" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-plane"></span>
													<input type="text" value="pe-7s-plane" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-joy"></span>
													<input type="text" value="pe-7s-joy" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-photo-gallery"></span>
													<input type="text" value="pe-7s-photo-gallery" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-pin"></span>
													<input type="text" value="pe-7s-pin" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-phone"></span>
													<input type="text" value="pe-7s-phone" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-plug"></span>
													<input type="text" value="pe-7s-plug" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-pen"></span>
													<input type="text" value="pe-7s-pen" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-right-arrow"></span>
													<input type="text" value="pe-7s-right-arrow" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-paper-plane"></span>
													<input type="text" value="pe-7s-paper-plane" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-delete-user"></span>
													<input type="text" value="pe-7s-delete-user" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-paint"></span>
													<input type="text" value="pe-7s-paint" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bottom-arrow"></span>
													<input type="text" value="pe-7s-bottom-arrow" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-notebook"></span>
													<input type="text" value="pe-7s-notebook" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-note"></span>
													<input type="text" value="pe-7s-note" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-next"></span>
													<input type="text" value="pe-7s-next" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-news-paper"></span>
													<input type="text" value="pe-7s-news-paper" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-musiclist"></span>
													<input type="text" value="pe-7s-musiclist" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-music"></span>
													<input type="text" value="pe-7s-music" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-mouse"></span>
													<input type="text" value="pe-7s-mouse" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-more"></span>
													<input type="text" value="pe-7s-more" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-moon"></span>
													<input type="text" value="pe-7s-moon" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-monitor"></span>
													<input type="text" value="pe-7s-monitor" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-micro"></span>
													<input type="text" value="pe-7s-micro" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-menu"></span>
													<input type="text" value="pe-7s-menu" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-map"></span>
													<input type="text" value="pe-7s-map" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-map-marker"></span>
													<input type="text" value="pe-7s-map-marker" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-mail"></span>
													<input type="text" value="pe-7s-mail" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-mail-open"></span>
													<input type="text" value="pe-7s-mail-open" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-mail-open-file"></span>
													<input type="text" value="pe-7s-mail-open-file" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-magnet"></span>
													<input type="text" value="pe-7s-magnet" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-loop"></span>
													<input type="text" value="pe-7s-loop" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-look"></span>
													<input type="text" value="pe-7s-look" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-lock"></span>
													<input type="text" value="pe-7s-lock" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-lintern"></span>
													<input type="text" value="pe-7s-lintern" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-link"></span>
													<input type="text" value="pe-7s-link" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-like"></span>
													<input type="text" value="pe-7s-like" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-light"></span>
													<input type="text" value="pe-7s-light" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-less"></span>
													<input type="text" value="pe-7s-less" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-keypad"></span>
													<input type="text" value="pe-7s-keypad" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-junk"></span>
													<input type="text" value="pe-7s-junk" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-info"></span>
													<input type="text" value="pe-7s-info" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-home"></span>
													<input type="text" value="pe-7s-home" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-help2"></span>
													<input type="text" value="pe-7s-help2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-help1"></span>
													<input type="text" value="pe-7s-help1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-graph3"></span>
													<input type="text" value="pe-7s-graph3" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-graph2"></span>
													<input type="text" value="pe-7s-graph2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-graph1"></span>
													<input type="text" value="pe-7s-graph1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-graph"></span>
													<input type="text" value="pe-7s-graph" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-global"></span>
													<input type="text" value="pe-7s-global" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-gleam"></span>
													<input type="text" value="pe-7s-gleam" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-glasses"></span>
													<input type="text" value="pe-7s-glasses" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-gift"></span>
													<input type="text" value="pe-7s-gift" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-folder"></span>
													<input type="text" value="pe-7s-folder" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-flag"></span>
													<input type="text" value="pe-7s-flag" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-filter"></span>
													<input type="text" value="pe-7s-filter" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-file"></span>
													<input type="text" value="pe-7s-file" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-expand1"></span>
													<input type="text" value="pe-7s-expand1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-exapnd2"></span>
													<input type="text" value="pe-7s-exapnd2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-edit"></span>
													<input type="text" value="pe-7s-edit" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-drop"></span>
													<input type="text" value="pe-7s-drop" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-drawer"></span>
													<input type="text" value="pe-7s-drawer" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-download"></span>
													<input type="text" value="pe-7s-download" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-display2"></span>
													<input type="text" value="pe-7s-display2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-display1"></span>
													<input type="text" value="pe-7s-display1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-diskette"></span>
													<input type="text" value="pe-7s-diskette" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-date"></span>
													<input type="text" value="pe-7s-date" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cup"></span>
													<input type="text" value="pe-7s-cup" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-culture"></span>
													<input type="text" value="pe-7s-culture" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-crop"></span>
													<input type="text" value="pe-7s-crop" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-credit"></span>
													<input type="text" value="pe-7s-credit" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-copy-file"></span>
													<input type="text" value="pe-7s-copy-file" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-config"></span>
													<input type="text" value="pe-7s-config" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-compass"></span>
													<input type="text" value="pe-7s-compass" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-comment"></span>
													<input type="text" value="pe-7s-comment" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-coffee"></span>
													<input type="text" value="pe-7s-coffee" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cloud"></span>
													<input type="text" value="pe-7s-cloud" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-clock"></span>
													<input type="text" value="pe-7s-clock" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-check"></span>
													<input type="text" value="pe-7s-check" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-chat"></span>
													<input type="text" value="pe-7s-chat" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-cart"></span>
													<input type="text" value="pe-7s-cart" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-camera"></span>
													<input type="text" value="pe-7s-camera" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-call"></span>
													<input type="text" value="pe-7s-call" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-calculator"></span>
													<input type="text" value="pe-7s-calculator" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-browser"></span>
													<input type="text" value="pe-7s-browser" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-box2"></span>
													<input type="text" value="pe-7s-box2" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-box1"></span>
													<input type="text" value="pe-7s-box1" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bookmarks"></span>
													<input type="text" value="pe-7s-bookmarks" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bicycle"></span>
													<input type="text" value="pe-7s-bicycle" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-bell"></span>
													<input type="text" value="pe-7s-bell" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-battery"></span>
													<input type="text" value="pe-7s-battery" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-ball"></span>
													<input type="text" value="pe-7s-ball" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-back"></span>
													<input type="text" value="pe-7s-back" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-attention"></span>
													<input type="text" value="pe-7s-attention" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-anchor"></span>
													<input type="text" value="pe-7s-anchor" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-albums"></span>
													<input type="text" value="pe-7s-albums" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-alarm"></span>
													<input type="text" value="pe-7s-alarm" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
											...
											<div class="font-icon-list col-md-2 col-sm-3 col-xs-6 col-xs-6">
												<div class="font-icon-detail"><span class="pe-7s-airplay"></span>
													<input type="text" value="pe-7s-airplay" readonly class="font-icon-name">
												</div>
												<fieldset class="font-icon-code">
