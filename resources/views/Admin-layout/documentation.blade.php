...
<head>
	...
	<!-- Custom CSS -->
	<link href="Admin-assets/dist/css/perfect-scrollbar.min.css" rel="stylesheet" type="text/css">
    ...
    <div class="wrapper  theme-1-active pimary-color-blue">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="documentation.html"><div class="pull-left"><i class="zmdi zmdi-book mr-20"></i><span class="right-nav-text">documentation</span></div><div class="clearfix"></div></a>
				</li>
				<li>
								...
								<div class="panel-body">
									...
									<div class="row mt-30">
										<div class="col-md-4 col-xs-12">
											<ul class="list-icons">
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> 7 Different Dashboards</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Ecommerce Pages Included</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> 95+ pages </li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> 1000+ fonts </li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> 300+ Ui Components</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Light,dark, and boxed layout.</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> toggle left side menu</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Used Bower A package manager for the web.</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Used gruntjs (The javascript task runner.)</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Vector Maps & Google maps included.</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Powered by Bootstrap Sass.</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>  CSS3 Animations.</li>
												
											</ul>
										</div>
										<div class="col-md-4 col-xs-12">
											<ul class="list-icons">
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Lots of widgets </li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Bootstrap 3x </li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> linea-icon Icons</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Themify Icons</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Simple line Icons</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Pe-icon Icons</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Responsive Layout</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> W3C HTML Valid code</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Multi-Browser Support</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Box & Full-screen layout options</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Dark & Light Demo options.</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Quick setting panel with many cool options.</li>
											</ul>
										</div>
										<div class="col-md-4 col-xs-12">
											<ul class="list-icons">
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Mobile Responsive Tabs</li>
												<li  class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Specially Designed Mobile Menu</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Desktop Sidebar Menu</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Tablet Icon Menu</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>  Multilevel Navigation</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Mega Menu</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Beautiful Profile page</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i> Working Instagram Live Feeds</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>Thoughtfully designed widgets.</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>Email App included.</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>Stunning Chat App included.</li>
												<li class="mb-10"><i class="zmdi zmdi-caret-right-circle txt-orange mr-5"></i>Login, Forget Password, Register, lock screen and many more.</li>
											</ul>
										</div>
									</div>
								</div>
						 ...
						 <div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<p>If everything was installed correctly, you should see the jQuery version of Snoopy running in <strong>http://localhost:9000/</strong></p>
									<br/>
									<p><strong>Above all procedures are optional you can directly use the compiled file(Admin-assets/dist/) which we provided you.</strong></p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<pre class="pt-20">
										  ...
										  │   └── Snoopy/
										  │       └── Admin-assets/dist
										  │            └── Admin-assets/distribution pkg(Ready to Use)
										  │       └── src
										  │            └── Source pkg
										  │       └── vendors
										  │            └── bower_components
				...
				<div class="row">
					<div class="col-sm-12">
						 <div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<p class="muted">custom js file in present in Admin-assets/dist/js folder.</p>
									<div class="table-responsive">  
										<table class="table table-bordered m-0">
											<thead>
											  <tr>
											...
											<tbody>
											  <tr>
												...
												<td>all custom js required for Snoopy.</td>
											  </tr>
						 ...
						 <div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<p class="muted">all js which are present in Admin-assets/dist/js folder with **-data are releted to individual pages. We used nomenclature related to inividual html page like chartjs-data.js for chats.html, bootstrap-wysuhtml5-data.js for bootstrap-wysihtml5.html etc.</p>
								</div>
							</div>
						</div>
					</div>
									...
									<pre class="pt-20 mt-20">
										&ltdiv class="logo-wrap"&gt
											&lta href="index.html"&gt
												&ltimg class="brand-img" src="../Admin-assets/img/logo.png" alt="brand"/&gt
												&ltspan class="brand-text"&gtSnoopy&lt/span&gt
											&lt/a&gt
										&lt/div&gt   
									</pre>	  
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<pre class="mt-20 pt-20">
										&ltdiv class="wrapper  theme-1-active pimary-color-blue"&gt
									</pre>
								</div>
							</div>
						</div>
										...
										&ltdiv id="carousel-example-captions" data-ride="carousel" class="carousel slide mt-40"&gt
											...
											&ltdiv role="listbox" class="carousel-inner"&gt
											   &ltdiv class="item active"&gt
												  &ltimg src="Admin-assets/dist/img/big/img1.jpg" alt="First slide image"&gt
												  &ltdiv class="carousel-caption"&gt
													&ltp&gt Lorem ipsum dolor sit amet, consectetur adipiscing elit. &lt/p&gt
												  &lt/div&gt
											   &lt/div&gt
											   &ltdiv class="item"&gt
												  &ltimg src="Admin-assets/dist/img/big/img2.jpg" alt="Second slide image"&gt
												  &ltdiv class="carousel-caption"&gt
													 &ltp&gt Lorem ipsum dolor sit amet, consectetur adipiscing elit. &lt/p&gt
												  &lt/div&gt
											   &lt/div&gt
											   &ltdiv class="item"&gt
												  &ltimg src="Admin-assets/dist/img/big/img3.jpg" alt="Third slide image"&gt
												  &ltdiv class="carousel-caption"&gt
													&ltp&gt Lorem ipsum dolor sit amet, consectetur adipiscing elit. &lt/p&gt
												  &lt/div&gt
											   &lt/div&gt
				...
				<div class="row">
					<div class="col-sm-12">
						 <div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">How to add modals ?</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<p class="muted mb-20">Please add below code snippet for modals.</p>
									<pre class="mt-20 pt-20">
										&ltdiv class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;"&gt
											&ltdiv class="modal-dialog modal-lg"&gt
												&ltdiv class="modal-content"&gt
													&ltdiv class="modal-header"&gt
														...
														&lth5 class="modal-title" id="myLargeModalLabel"&gtLarge modal&lt/h5&gt
													&lt/div&gt
													&ltdiv class="modal-body"&gt
														&lth5 class="mb-15"&gtOverflowing text to show scroll behavior&lt/h5&gt
														&ltp&gtPraesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.&lt/p&gt
														&ltp&gtAenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla.&lt/p&gt
													&lt/div&gt
													&ltdiv class="modal-footer"&gt
														&ltbutton type="button" class="btn btn-danger text-left" data-dismiss="modal"&gtClose&lt/button&gt
													&lt/div&gt
												&lt/div&gt
												&lt!-- /.modal-content --&gt
											&lt/div&gt
										...
										&ltimg src="Admin-assets/dist/img/modals/model2.png" alt="default" data-toggle="modal" data-target=".bs-example-modal-lg" class="model_img img-responsive"/&gt 
									</pre>
								</div>
							</div>
						</div>
