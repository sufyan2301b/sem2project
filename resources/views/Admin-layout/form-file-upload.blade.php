...
<html lang="en">
	<head>
		...
		<link href="../Admin-assets/vendors/bower_components/dropify/Admin-assets/dist/css/dropify.min.css" rel="stylesheet" type="text/css"/>
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="form-file-upload.html">File Upload</a>
							</li>
							<li>
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="mt-40">
											<input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../Admin-assets/vendors/bower_components/dropify/src/images/test-image-1.jpg" />
										</div>	
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="mt-40">
											<input type="file" id="input-file-now-custom-3" class="dropify" data-height="500" data-default-file="../Admin-assets/vendors/bower_components/dropify/src/images/test-image-2.jpg" />
										</div>	
									</div>
								</div>
							</div>
		...
		<script src="../Admin-assets/vendors/bower_components/dropify/Admin-assets/dist/js/dropify.min.js"></script>
