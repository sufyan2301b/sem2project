...
<html lang="en">
	<head>
		...
		<!-- vector map CSS -->
		<link href="../Admin-assets/vendors/bower_components/cropperjs/Admin-assets/dist/cropper.min.css" rel="stylesheet" type="text/css"/>
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="cropperjs.html">Cropperjs</a>
							</li>
							<li>
										...
										<div class="row mt-40">
											<div class="col-md-8">
												...
												<div class="img-container">
													<img src="../Admin-assets/img/cropper.jpg" alt="Picture">
												</div>
											</div>
											<div class="col-md-4">
		...
		<!-- Cropper -->
		<script src="../Admin-assets/vendors/bower_components/cropperjs/Admin-assets/dist/cropper.min.js"></script>
		<script src="Admin-assets/dist/js/cropperjs-data.js"></script>
