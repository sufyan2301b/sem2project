...
<body>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="chart_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a class="active-page" href="flot-chart.html">Flot Chart</a>
						</li>
						<li>
	...
	<script src="../Admin-assets/vendors/bower_components/Flot/excanvas.min.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.pie.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.resize.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.time.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.stack.js"></script>
	<script src="../Admin-assets/vendors/bower_components/Flot/jquery.flot.crosshair.js"></script>
	<script src="../Admin-assets/vendors/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
	<script src="Admin-assets/dist/js/flot-data.js"></script>
