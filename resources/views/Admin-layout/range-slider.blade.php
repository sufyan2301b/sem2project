...
<html lang="en">
	...
	<body>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page"  href="range-slider.html">Range Slider</a>
							</li>
							<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">range slider</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>range slider</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 1</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 2</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
											<div class="panel-body">
												...
												<div class="mt-40">
													<input type="text" id="range_1" value="" name="range" />
												</div>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 3</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
											<div class="panel-body">
												...
												<div class="mt-40">
													<input type="text" id="range_2" value="" name="range" />
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 4</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
											<div class="panel-body">
												...
												<div class="mt-40">
													<input type="text" id="range_3" value="" name="range" />
												</div>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 5</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Range slider type 6</h6>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="panel-wrapper collapse in">
											<div class="panel-body">
												...
												<div class="mt-40">
													<input type="text" id="range_5" value="" name="range" />
												</div>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="panel panel-default card-view">
										...
										<div class="panel-wrapper collapse in">
											<div class="panel-body">
												<p class="muted">Grid With time in 24 hour format.</p>
												<div class="mt-40">
													<input type="text" id="range_6" value="" name="range" />
												</div>
											</div>
										</div>
									</div>
		...
		<!-- Slimscro../Admin-assets/ll JavaScript -->
		<script src="../Admin-assets/dist/js/jquery.slimscroll.js"></script>
	
		<!-- Fancy Dr../Admin-assets/opdown JS -->
