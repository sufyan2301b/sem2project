				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="icon_dr" class="collapse collapse-level-1">
							...
							<li>
								<a class="active-page" href="glyphicons.html">Glyphicons</a>
							</li>
						</ul>
					</li>
					<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">glyphicon font</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>glyphicon-icons</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Glyphicons <span class="txt-grey capitalize-font">(250 Glyphs)</span></h6>
									</div>
