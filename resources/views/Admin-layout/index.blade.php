				...
				<div class="panel panel-default card-view">
					...
					<div class="panel-wrapper collapse in">
						<div class="panel-body">
							...
							<div id="e_chart_1" class="" style="height:418px;"></div>
						</div>
					</div>
				</div>
			</div>
								...
								<div role="listbox" class="carousel-inner mb-50">
									<div class="item active"> 
										<div class="testimonial-wrap text-center  pl-30 pr-30">
											<img class="img-circle" src="../Admin-assets/img/user1.png" alt="First slide image"> 
									...
									<div class="item"> 
										<div class="testimonial-wrap text-center  pl-30 pr-30">
											<img class="img-circle" src="../Admin-assets/img/user2.png" alt="First slide image"> 
									...
									<div class="item"> 
										<div class="testimonial-wrap text-center  pl-30 pr-30">
											<img class="img-circle" src="../Admin-assets/img/user3.png" alt="First slide image"> 
			...
			<div class="col-lg-8 col-md-6 col-xs-12">
				<div class="panel panel-default card-view panel-refresh">
					...
					<div class="panel-heading">
						...
						<div class="pull-right">
							<a href="javascript:void(0)" class="pull-left btn btn-warning btn-xs mr-15">view all</a>
